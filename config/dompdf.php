...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        // Use DomPDF's bundled fonts directly — the vendor lib has both .ttf source
        // files and matching .ufm metrics, avoiding subset/glyph-map corruption that
        // happens when only the .ufm.json metrics land in storage/fonts.
