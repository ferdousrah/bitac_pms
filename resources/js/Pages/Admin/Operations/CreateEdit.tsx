...
export default function OperationCreateEdit({ operation, sections }: any) {
    ...
    const { data, setData, post, put, processing, errors } = useForm({
        ...
        rate_group_student:  operation?.rate_group_student ?? '',
        rate_group_public:   operation?.rate_group_public ?? '',
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="card animate-slide-up">
                        <div className="card-header">
                            ...
                            <p className="text-xs text-surface-400">A=Cottage · B=Corporate · C=Import Substitute · Student · Public</p>
                        </div>
                        <div className="card-body space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {([
                                    ...
                                    <div key={g.key} className="form-group">
                                        <label className="form-label">{g.label} <span className="form-label-optional">৳/{data.default_unit}</span></label>
