...
export default function CustomerComplaintsIndex({ complaints }: any) {
    ...
    return (
        <CustomerLayout title="Complaints / Feedback">
            ...
            <div className="card">
                <div className="card-header">
                    <h2 className="text-sm font-semibold text-surface-800">All Complaints</h2>
                    <p className="text-xs text-surface-400 mt-0.5">Track status of your feedback and complaints</p>
                </div>
                <div className="card-body p-0">
                    {rows.length === 0 ? (
                        <div className="empty-state">
                            ...
                            <p className="empty-state-text">Submit feedback or report an issue with any of your orders.</p>
                            <div className="mt-4">
                                <Link href="/customer/complaints/create" className="btn-primary btn-sm">
                                    <i className="fi fi-rr-plus text-xs leading-none" /> File a Complaint
                                </Link>
                            </div>
                        </div>
                    ) : (
