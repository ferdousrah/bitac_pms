...
- The link **refuses** an estimate that is already tied to another quotation, or whose `rfq_id` isn't the quotation's — so a second quotation can't steal it and nothing cross-links between RFQs.
