...
**Phases:** 1) Sub-section foundation ✅ · 2) Quantity model + daily log + qty-based progress ✅ · 2.5) Section-level weightage ✅ · 3) Partial forward (section qty ledger, handoff qty) + Upcoming Jobs · 4) Per-section Job-Detail (production-cycle) page + machine-running state + progress/PDF sync.
