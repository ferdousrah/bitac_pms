...
**Phases:** 1) Sub-section foundation ✅ · 2) Quantity model + daily log + qty-based progress ✅ · 2.5) Section-level weightage ✅ · 3) Partial forward (section qty ledger, explicit transfer, no auto-forward) ✅ · 3.5) Upcoming Jobs · 4) Per-section Job-Detail (production-cycle) page + machine-running state + progress/PDF sync.
